                                ...
                                <form class='form p-t-20' enctype='multipart/form-data' method='POST' action="">
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='input-group'>
                                            ...
                                            <input name='' value='' class='form-control text-lower' id='exampleInputuname' placeholder='section name'>
                                        </div>
                                    </div>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='input-group'>
                                            <div class='input-group-addon'><i class='ti ti-pencil'></i></div>
                                            <input name='' value='' class='form-control text-lower' id='exampleInputuname' placeholder='input'>
                                        </div>
                                    </div>
