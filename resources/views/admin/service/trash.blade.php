                    ...
                    <div class="col-md-6 card m-auto">
                        <div class="card-body">
                            <div class="row button-group">
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <a href="{{route('frontend_service')}}" type="button" class="btn btn-block btn-outline-primary">All services</a>
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <a href="{{route('frontend_service_trash')}}" type="button" class="btn active btn-block btn-outline-primary">All Trash</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form p-t-20" method="POST" action="{{route('frontend_service_upadate',$item->slug)}}">
                                    ...
                                    <button type="submit" class="btn text-capitalize btn-outline-primary waves-effect waves-light m-r-10">update service information</button>
                                    <a class="btn btn-outline-danger waves-effect waves-light m-r-10" href="{{route('frontend_service_hard_delete',$item->slug)}}">Delete</a>
                                    <a class="btn btn-outline-info waves-effect waves-light m-r-10" href="{{route('frontend_service_restore',$item->slug)}}">Restore</a>
                                </form>
                            </div>
                        </div>
                    </div>
