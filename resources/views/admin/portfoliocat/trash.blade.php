                ...
                <div class='row' style='margin:30px'>
                    ...
                    <div class='card'>
                            <div class='card-body'>
                                ...
                                <form class='form p-t-20' method='POST' action='{{route("fortfolio_categories_delete",$item->slug)}}'>
                                    @csrf
                                    ...
                                    <a class='btn btn-outline-danger text-capitalize waves-effect waves-light m-r-10' href="{{route('fortfolio_categories_delete',$item->slug)}}">delete</a>
                                </form>
                                @endforeach
                            </div>
                        </div>
