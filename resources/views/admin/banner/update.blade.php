                                    ...
                                    <form class="form p-t-20" enctype="multipart/form-data" method="POST" action="{{route('frontend_banner_update_banner',$item->slug)}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="file" value="{{$item->name}}" name="name" class="form-control" id="exampleInputuname" placeholder="Username">
                                            </div>
                                            <img src="{{asset('uploads')}}/{{$item->name}}" style="height:100px; width:150px; margin-top:20px;" alt="{{$item->name}}">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Banner Subtitle</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-comment"></i></div>
                                                <input type="text" name="subtitle" value="{{$item->subtitle}}" class="form-control" id="exampleInputEmail1" placeholder="Enter subtitle">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="Title" name="title" value="{{$item->title}}" class="form-control" id="pwd1" placeholder="Enter title">
                                            </div>
                                        </div>
